...
const attractionsLib = require(path.join(__dirname, '../../miniprogram/data/attractions.js'));
const recommendLib = require(path.join(__dirname, '../../miniprogram/data/recommend.js'));
